...
int main(int argc, char *argv[]){
    ...
    vector<string>::const_iterator i = result.begin();
		...
		const shared_ptr<RecognizerPointer> recognizptrLoaded1 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded2 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded3 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded4 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded5 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded6 = RecognizerPointer::loadVect(i);
		const shared_ptr<RecognizerPointer> recognizptrLoaded7 = RecognizerPointer::loadVect(i);
