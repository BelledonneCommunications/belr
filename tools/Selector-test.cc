...
//verification avec feed
  ...
  //SAVE AND LOAD
	ofstream ofichier ("test-sel.txt", ios::out | ios::app);
  selector1->save(ofichier, savePosition);
	...
	ifstream ifichier ("test-sel.txt", ios::in);
	const shared_ptr<Selector> selectorLoaded1 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded2 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded3 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded4 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded5 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded6 = Selector::load(ifichier , loadPosition);
	const shared_ptr<Selector> selectorLoaded7 = Selector::load(ifichier , loadPosition);
