...
//Sequence with a RecognizerPointer
  ...
  //SAVE AND LOAD
	ofstream ofichier ("test-seq.txt", ios::out | ios::app);
  ...
  sequence4->save(ofichier, savePosition);
	...
	ifstream ifichier ("test-seq.txt", ios::in);
	const shared_ptr<Sequence> sequenceLoaded1 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded2 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded3 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded4 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded5 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded6 = Sequence::load(ifichier, loadPosition);
	const shared_ptr<Sequence> sequenceLoaded7 = Sequence::load(ifichier, loadPosition);
